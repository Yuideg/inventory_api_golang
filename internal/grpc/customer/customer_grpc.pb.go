...
type CustomerServiceClient interface {
	...
	CustomerByID(ctx context.Context, in *CustomerByIDRequest, opts ...grpc.CallOption) (*CustomerByIDResponse, error)
...
func (c *customerServiceClient) CustomerByID(ctx context.Context, in *CustomerByIDRequest, opts ...grpc.CallOption) (*CustomerByIDResponse, error) {
	out := new(CustomerByIDResponse)
	err := c.cc.Invoke(ctx, "/customer.CustomerService/CustomerByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *customerServiceClient) CustomerList(ctx context.Context, in *CustomerListRequest, opts ...grpc.CallOption) (*CustomerListResponse, error) {
	out := new(CustomerListResponse)
	err := c.cc.Invoke(ctx, "/customer.CustomerService/CustomerList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CustomerServiceServer interface {
	...
	CustomerByID(context.Context, *CustomerByIDRequest) (*CustomerByIDResponse, error)
...
func (UnimplementedCustomerServiceServer) CustomerByID(context.Context, *CustomerByIDRequest) (*CustomerByIDResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CustomerByID not implemented")
}
func (UnimplementedCustomerServiceServer) CustomerList(context.Context, *CustomerListRequest) (*CustomerListResponse, error) {
...
func _CustomerService_CustomerByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CustomerByIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CustomerServiceServer).CustomerByID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/customer.CustomerService/CustomerByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).CustomerByID(ctx, req.(*CustomerByIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CustomerService_CustomerList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CustomerListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CustomerServiceServer).CustomerList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/customer.CustomerService/CustomerList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).CustomerList(ctx, req.(*CustomerListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CustomerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CustomerService_CustomerByID_Handler,
		},
		{
