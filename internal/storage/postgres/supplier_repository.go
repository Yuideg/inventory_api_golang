...
func (pgx *SupplierIMP) Create(supplier model.Supplier) (pgconn.CommandTag, error) {
...
func (pgx *SupplierIMP) GetById(id uuid.UUID) (*model.Supplier, error) {
...
func (pgx *SupplierIMP) Get() ([]model.Supplier, error) {
...
func (pgx *SupplierIMP) Update(supplier *model.Supplier) (pgconn.CommandTag, error) {
...
func (pgx *SupplierIMP) Delete(id uuid.UUID) error {
